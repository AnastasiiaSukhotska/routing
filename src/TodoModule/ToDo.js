...
onItemChooseHandler = (id, e) => {
   ...
   this.setState({
       ...
       console.log(this.state.chosenItem, 'chosen');
...
onHistoryChangeHandler = (historyItem) => {
    ...
    this.setState({
        list: [...this.state.list.history, historyItem],
    }, () => {
        console.log (this.state.list, 'jjj');
    });
}
    render() {
        return (
            <div className="wrapper">
             <div className="sidebar-root">
                ...
                <div>
                        ...
                        onHistoryChange = {this.onHistoryChangeHandler}
